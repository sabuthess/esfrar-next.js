...
export default function ImagesFavoritesUser() {
    ...
    const navigation = [
        { name: 'Tus imagenes', href: '/dashboard', icon: HomeIcon, current: false },
        { name: 'Imagenes Favoritas', href: '/dashboard/favorites', icon: BookmarkIcon, current: true },
                    ...
                    <main className="flex-1">
                        <div className="py-6">
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                                <h1 className="text-2xl font-semibold text-gray-900">Mis imagenes favoritas</h1>
                            </div>
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                                ...
                                <div className="py-4">
                                    ...
                                    <div className="w-[90%] mx-auto p-5 my-10">
                                        ...
                                        {images.length === 0 && <p>No tienes ninguna imagen favorita.</p>}
                                    </div>
                                </div>
